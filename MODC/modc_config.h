...
#define Modc_TASK_PERIOD              (10U)  /* 10ms */
#define Modc_DELAY_5S                 (5000U)
#define Modc_DELAY_50MS               (50U)
#define Modc_DELAY_30MS               (30U)
#define Modc_DELAY_20MS               (20U)
#define Modc_DELAY_10MS               (10U)

#define Modc_ERR_CNT_PLUS_STEP        (10U)
#define Modc_ERR_CNT_MINUS_STEP       (2U)
#define Modc_ERR_CNT_RECOVERY_STEP    (1U)
#define Modc_ERR_CNT_ERR_TSD_THRES    (50U)
#define Modc_ERR_CNT_ERR_OC_THRES     (100U)
#define Modc_ERR_CNT_ERR_Fault_THRES  (50U)
#define Modc_ERR_CNT_OC_PROT_TIME     ((uint16)(Modc_DELAY_5S / Modc_TASK_PERIOD))
#define Modc_ERR_CNT_TSD_PROT_TIME    (5000U)
#define Modc_ERR_CNT_Fault_PROT_TIME  ((uint16)(Modc_DELAY_5S / Modc_TASK_PERIOD))
#define Modc_ERR_CNT_RESTORE_TIME     ((uint16)(Modc_DELAY_5S / Modc_TASK_PERIOD))
...
#define Modc_SPI_TRANSMIT_TIMEOUT     ((uint8)(Modc_DELAY_20MS / Modc_TASK_PERIOD))
...
#define MODC_REG_VDS_CTRL1           (MODC_VDS_H_1000mV | MODC_VDS_L_2000mV)
#define MODC_REG_VDS_CTRL2           (MODC_VDS_H_2000mV | MODC_VDS_L_140mV)
#define MODC_REG_VDS_CTRL3           (MODC_VDS_H_140mV | MODC_VDS_L_2000mV)
#define MODC_REG_VDS_CTRL4           (MODC_VDS_H_2000mV | MODC_VDS_L_1000mV)
...
#define MODC_REG_CSA_CTRL1           (MODC_CSA_DIV_1_AREF_8 | MODC_CSA_GAIN_1_10VV | MODC_CSA_DIV_2_AREF_8 | MODC_CSA_GAIN_2_10VV)
...
/* OD                                                                         */
/*----------------------------------------------------------------------------*/
extern Spi_SeqResultType Modc_SpiGetSequenceResult(void);
...
/* OD                                                                         */
/*----------------------------------------------------------------------------*/
extern Std_ReturnType Modc_SpiTransmitFrame(SPIC_Reqtype_t* req);
#endif
